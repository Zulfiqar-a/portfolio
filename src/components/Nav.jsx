  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-md bg-[color:var(--void)]/70 border-b border-[color:var(--line)]">
      <nav className="max-w-6xl mx-auto flex items-center justify-between px-6 md:px-10 h-16">
        <a
          href="#top"
          className="font-mono-label text-sm text-[color:var(--ink)] hover:text-[color:var(--violet)] transition-colors"
        >
        ...
        <a
          href="#contact"
          className="text-sm px-4 py-2 rounded-full border border-[color:var(--line)] text-[color:var(--ink)] hover:border-[color:var(--violet)] hover:text-[color:var(--violet)] transition-colors"
        >
          Let's talk
        </a>
      </nav>
